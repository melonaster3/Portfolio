    ...
    <div name="skills" className="bg-[black] text-[#F0EBE3] w-full h-screen">
      <div className = 'max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8">
            <div className="hover:bg-[#76BB85] hover:scale-110 hover:font-bold hover:text-[black] duration-500 mt-14 pt-6" data-aos="flip-down">
            ...
            <div className="hover:bg-[#76BB85] hover:scale-110 hover:font-bold hover:text-[black] duration-500 mt-14 pt-6" data-aos="flip-up">
