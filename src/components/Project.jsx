  ...
  return (
    ...
    >
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        <div className="pb-8">
          <p className="text-4xl font-bold inline border-b-4 text-#576F72 border-[#76BB85]" data-aos="fade-down" >
            Projects
          </p>
        </div>
        ...
        <div className="mt-10 mb-12 flex flex-row">
          <div>
            ...
            <p className="text-xl font-bold inline text-[#76BB85] border-[#76BB85]" data-aos="fade-right">
              Lightmarket
            </p>
            <a
              className="ml-6"
            ...
            <div className = "flex flex-row ">
            <p className="ml-6 mt-2 font-bold text-lg inline text-#576F72 " data-aos="zoom-in">
        ...
        <div className="mt-10 mb-12 flex flex-row">
          <div>
            ...
            <div className = "flex flex-row ">
            <p className="ml-6 mt-2 text-lg font-bold  inline text-#576F72 "  data-aos="zoom-in">
