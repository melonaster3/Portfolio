...
const Contact = () => {
  return (
    <div name = 'contact' className='w-full h-screen text-black bg-[#0a192f] flex justify-center items-center p-4'>
        <form method = 'POST' action ="https://getform.io/f/28111fed-8adf-4344-a90b-d3ed1f7fb690" className = 'flex flex-col max-w-[600px] w-full' >
            <div className = 'pb-8'>
                ...
                <p className = "text-gray-300 py-4">Submit the form below or shoot me an email - sangyoon.lee@ucalgary.ca</p>
           </div>
