        ...
        <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4">
          ...
          >
            <p>
              ...
              experiences. I am passionate on the projects <br /> I build and
              love to learn new languages and skills. <br /> Creative in
              frontend development and meticulous in backend development.
            </p>
            <p className="mt-4">
              <b>Education</b>
            </p>
