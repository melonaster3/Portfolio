      ...
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        ...
        <div className="mt-10 mb-12 flex flex-row">
          <div>
            ...
            <div className="border rounded w-full h-fit m-5 hover:shadow-lg hover:shadow-[#040c16] ">
              <img className="object-contain" src={light}></img>
            </div>
            <div className = "flex flex-row ">
        ...
        <div className="mt-10 mb-12 flex flex-row">
          <div>
            ...
            <div className="border rounded w-full h-fit m-5 hover:shadow-lg hover:shadow-[#040c16] ">
              <img className="object-contain" src={interviewer}></img>
            </div>
            <div className = "flex flex-row ">
            <p className="ml-6 mt-2 font-bold text-lg inline text-#576F72 ">
        ...
        <div className="mt-10 mb-12 flex flex-row">
          <div>
            ...
            <a
              className="ml-6"
              href="https://github.com/melonaster3/Portfolio"
            >
              <FaGithub size={30}/>
            </a>
            </div>
            <div className="border rounded w-full h-fit m-5 hover:shadow-lg hover:shadow-[#040c16]">
              <img className="object-contain	" src={tweeter}></img>
            </div>
            <div className = "flex flex-row ">
